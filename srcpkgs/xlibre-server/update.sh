...
export SHA256=$(curl -L https://github.com/X11Libre/xserver/releases/download/xlibre-xserver-${VERSION}/archive/refs/tags/xlibre-xserver-${version}.tar.gz.sha256 | cut -d ' ' -f1 )
